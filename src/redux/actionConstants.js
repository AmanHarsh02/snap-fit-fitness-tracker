export const BASE_URL = "https://snap-fit-api.amanharsh1.repl.co/api/v1";
...
export const SET_USER_SIGNUP_INPUT = "set_user_signup_input";
...
export const SET_EXERCISE_INPUT = "set_exercise_input";

export const SET_EXERCISES = "set_exercises";
export const ADD_EXERCISE = "add_exercise";
export const DELETE_EXERCISE = "delete_exercise";
export const SET_EXERCISE_CARD_COLORS = "set_exercise_card_colors";
export const ADD_EXERCISE_CARD_COLOR = "add_exercise_card_color";
